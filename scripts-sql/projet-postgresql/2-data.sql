...
--responsable
INSERT INTO "responsable" (id_responsable,idcategorie,nom_complet,adresse,permis_conduire,brevet_secourisme,code,telephone,info_supplementaires,date_naissance) 
...
ALTER TABLE responsable ALTER COLUMN id_responsable RESTART WITH 10;
...
alter table equipe_attente alter column id restart with 11;
...
alter table participant_attente alter column id restart with 11;
--equipe
...
alter table equipe alter column id restart with 9;
--participant
...
alter table participant alter column id restart with 11;
--localisation
